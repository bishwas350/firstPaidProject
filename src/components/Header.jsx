...
const Header = () => {
  ...
  return (
    <>
      <main>
        <div className="bg-black py-5 relative z-40">
          <Container>
            <Flex className={'justify-between items-center relative '}>
              ...
              {open && (
                <div className={`fixed lg:hidden left-0 top-[64px] z-50 animate__animated ${animateOut ? "animate__fadeOutLeft" : "animate__fadeInLeft"}`}>
